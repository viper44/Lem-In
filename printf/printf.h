...
void			*ft_memset_p(void *memptr, int val, size_t num);
char			*ft_strdup_p(const char *str);
char			*ft_strsub_p(char const *s, unsigned int start, size_t len);
...
char			*itoa_base_p(long long int value, int base);
